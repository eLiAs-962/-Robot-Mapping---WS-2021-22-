...
function [dx,H] = linearize_and_solve(g)
...
%% Note : All the linearization process
% performed around the current graph configuration, thus 
% the initila spational configuration is the graph current configuration
